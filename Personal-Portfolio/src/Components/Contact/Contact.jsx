...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_ck83dbd', 'template_7y7u2ps', form.current, {
        publicKey: 'YcN9BoN-dGP1_jVqW',
      })
      e.target.reset()
  };
    ...
    <section className="contact section" id="contact">
        ...
        <div className="contact__container container grid">
            <div className="cantact__content">
                <h3 className="contact__title talk__to-me">Talk to me</h3>
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">dhananjoybrahma@gmail.com</span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+91-9365572247</span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">facebook.com/dhananjoy.brahma.14</span>
